...
var nunjucks = require('./nunjucks.min.js')



var html = fs.readFileSync(path.join(__dirname, '../unpackage/dist/build/h5/index.html'), 'utf-8')
//读取host
...
function activate(context) {
	...
	var pathUrl=path.normalize(path.format({
	  dir: __dirname,
	...
	var res = nunjucks.renderString(html, {
		path: 'C:/Users/Administrator/Documents/HBuilderProjects/HBuilder-plin-hosts/ui/unpackage/dist/build/h5',//path.join(__dirname,'../unpackage/dist/build/h5'),
		sh: {
			"list": [{
